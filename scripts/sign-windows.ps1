...
$certificate.Import($bytes, $env:WINDOWS_SIGN_PASSWORD, [System.Security.Cryptography.X509Certificates.X509KeyStorageFlags]::EphemeralKeySet)
try {
...
} finally { $certificate.Dispose(); [Array]::Clear($bytes, 0, $bytes.Length) }
